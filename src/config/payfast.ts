...
export const PAYFAST_CONFIG = {
  ...
  MERCHANT_ID: process.env.VITE_PAYFAST_MERCHANT_ID || 'your_merchant_id_here',
  MERCHANT_KEY: process.env.VITE_PAYFAST_MERCHANT_KEY || 'your_merchant_key_here',
  PASSPHRASE: process.env.VITE_PAYFAST_PASSPHRASE || '', // Optional but recommended
